...
export function WordJudgeCard({ card, isTop, stackOffset, onJudge, defaultRevealed = false }: WordJudgeCardProps) {
  ...
  }, [isTop, exitDirection, isRevealed, handleReveal, commitJudge]);
  ...
  return (
    ...
    >
      ...
      <div className="my-auto flex w-full flex-col items-center justify-center gap-2 py-4 text-center select-none pointer-events-none">
        <p className={`w-full font-mincho font-bold text-ink tracking-tight whitespace-nowrap leading-normal py-2 select-none ${headwordFontSize}`}>
          {card.headword}
        </p>
        {card.pronunciation ? (
